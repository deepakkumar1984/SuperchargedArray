...
namespace OpenCL.Tensor
{
    ...
    public partial class NDArray : IDisposable
    {
        ...
        {
            return Global.Ops.Tile(this, repetitions);
        }
        ...
        {
            return Global.Ops.Add(lhs, rhs);
        }

        public static NDArray operator +(NDArray lhs, float rhs) { return Global.Ops.Add(lhs, rhs); }

        public static NDArray operator +(float lhs, NDArray rhs) { return Global.Ops.Add(rhs, lhs); }

        public static NDArray operator -(NDArray lhs, NDArray rhs)
        {
            return Global.Ops.Sub(lhs, rhs);
        }

        public static NDArray operator -(NDArray lhs, float rhs) { return Global.Ops.Sub(lhs, rhs); }

        public static NDArray operator -(float lhs, NDArray rhs) { return Global.Ops.Sub(lhs, rhs); }

        public static NDArray operator *(NDArray lhs, NDArray rhs)
        {
            return Global.Ops.Mul(lhs, rhs);
        }

        public static NDArray operator *(NDArray lhs, float rhs) { return Global.Ops.Mul(lhs, rhs); }

        public static NDArray operator *(float lhs, NDArray rhs) { return Global.Ops.Mul(rhs, lhs); }

        public static NDArray operator /(NDArray lhs, NDArray rhs)
        {
            return Global.Ops.Div(lhs, rhs);
        }

        public static NDArray operator /(NDArray lhs, float rhs) { return Global.Ops.Div(lhs, rhs); }

        public static NDArray operator /(float lhs, NDArray rhs) { return Global.Ops.Div(rhs, lhs); }

        public static NDArray operator >(NDArray lhs, NDArray rhs) { return Global.Ops.GreaterThan(lhs, rhs); }

        public static NDArray operator >(NDArray lhs, float rhs) { return Global.Ops.GreaterThan(lhs, rhs); }

        public static NDArray operator <(NDArray lhs, NDArray rhs)
        {
            return Global.Ops.GreaterThan(rhs, lhs);
        }

        public static NDArray operator <(NDArray lhs, float rhs)
        {
            NDArray rhs_t = NDArray.Constant(rhs, lhs.ElementType, lhs.shape);
            return Global.Ops.GreaterThan(rhs_t, lhs);
        }

        public static NDArray operator >=(NDArray lhs, NDArray rhs) { return Global.Ops.GreaterOrEqual(lhs, rhs); }

        public static NDArray operator >=(NDArray lhs, float rhs) { return Global.Ops.GreaterOrEqual(lhs, rhs); }

        public static NDArray operator <=(NDArray lhs, NDArray rhs)
        {
            return Global.Ops.GreaterOrEqual(rhs, lhs);
        }

        public static NDArray operator <=(NDArray lhs, float rhs)
        {
            NDArray rhs_t = NDArray.Constant(rhs, lhs.ElementType, lhs.shape);
            return Global.Ops.GreaterOrEqual(rhs_t, lhs);
        }
