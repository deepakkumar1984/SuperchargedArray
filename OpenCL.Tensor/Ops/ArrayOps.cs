...
namespace OpenCL.Tensor
{
    ...
    public class ArrayOps : BaseOps
    {
        ...
        public void Fill(NDArray x, float value)
        {
        ...
        /// <param name="src">The source.</param>
        /// <returns>NDArray.</returns>
        public NDArray Log10( NDArray x)
        {
            NDArray result = new NDArray(x.Shape);
        ...
        /// <param name="src">The source.</param>
        /// <returns>NDArray.</returns>
        public NDArray Floor( NDArray x)
        {
            NDArray result = new NDArray(x.Shape);
        ...
        /// NDArray.
        /// </returns>
        public NDArray Round( NDArray x, int decimals = 0)
        {
            NDArray result = new NDArray(x.Shape);
            if (decimals > 0)
        ...
        /// NDArray.
        /// </returns>
        public NDArray Trunc(NDArray x) {
            NDArray result = new NDArray(x.Shape);
        ...
        /// NDArray.
        /// </returns>
        public NDArray Atan2(NDArray y,NDArray x)
        {
            NDArray result = new NDArray(x.Shape);
            Parallel.For(0, x.Elements, (i) =>
            {
        ...
        /// NDArray.
        /// </returns>
        public NDArray Pow(NDArray x, float value)
        {
            NDArray result = new NDArray(x.Shape);
            Parallel.For(0, x.Elements, (i) =>
            {
        ...
        /// NDArray.
        /// </returns>
        public NDArray TPow(float value, NDArray x)
        {
            NDArray result = new NDArray(x.Shape);
            Parallel.For(0, x.Elements, (i) =>
            {
        ...
        /// NDArray.
        /// </returns>
        public NDArray Lerp(NDArray x0, NDArray x1, float weight)
        {
        ...
        /// NDArray.
        /// </returns>
        public NDArray Clip(NDArray x, float min, float max)
        {
            NDArray result = new NDArray(x.Shape);
            Parallel.For(0, x.Elements, (i) =>
            {
        ...
        /// NDArray.
        /// </returns>
        public NDArray Add(NDArray lhs, NDArray rhs)
        {
        ...
        /// NDArray.
        /// </returns>
        public NDArray Add(NDArray lhs, float rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// NDArray.
        /// </returns>
        public NDArray Add(float lhs, NDArray rhs)
        {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns></returns>
        public NDArray Sub(NDArray lhs, NDArray rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns></returns>
        public NDArray Sub(NDArray lhs, float rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns></returns>
        public NDArray Sub(float lhs, NDArray rhs)
        {
            NDArray result = new NDArray(rhs.Shape);
            Parallel.For(0, rhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns></returns>
        public NDArray Mul(NDArray lhs, NDArray rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns></returns>
        public NDArray Mul(NDArray lhs, float rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns></returns>
        public NDArray Mul(float lhs, NDArray rhs)
        {
            NDArray result = new NDArray(rhs.Shape);
            Parallel.For(0, rhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns></returns>
        public NDArray Div(NDArray lhs, NDArray rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns></returns>
        public NDArray Div(NDArray lhs, float rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns></returns>
        public NDArray Div(float lhs, NDArray rhs)
        {
            NDArray result = new NDArray(rhs.Shape);
            Parallel.For(0, rhs.Elements, (i) =>
            {
        ...
        /// NDArray.
        /// </returns>
        public NDArray Mod(NDArray x, float scalar)
        {
            NDArray result = new NDArray(x.Shape);
            Parallel.For(0, x.Elements, (i) =>
            {
        ...
        /// NDArray.
        /// </returns>
        public NDArray Mod(NDArray lhs, NDArray rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns>NDArray.</returns>
        public NDArray GreaterThan( NDArray lhs, float rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns>NDArray.</returns>
        public NDArray LessThan( NDArray lhs, float rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns>NDArray.</returns>
        public NDArray GreaterOrEqual( NDArray lhs, float rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns>NDArray.</returns>
        public NDArray LessOrEqual( NDArray lhs, float rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns>NDArray.</returns>
        public NDArray EqualTo( NDArray lhs, float rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns>NDArray.</returns>
        public NDArray NotEqual( NDArray lhs, float rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns>NDArray.</returns>
        public NDArray GreaterThan( NDArray lhs, NDArray rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns>NDArray.</returns>
        public NDArray LessThan( NDArray lhs, NDArray rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns>NDArray.</returns>
        public NDArray GreaterOrEqual( NDArray lhs, NDArray rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns>NDArray.</returns>
        public NDArray LessOrEqual( NDArray lhs, NDArray rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns>NDArray.</returns>
        public NDArray EqualTo( NDArray lhs, NDArray rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// <param name="rhs">The RHS.</param>
        /// <returns>NDArray.</returns>
        public NDArray NotEqual( NDArray lhs, NDArray rhs)
        {
            NDArray result = new NDArray(lhs.Shape);
            Parallel.For(0, lhs.Elements, (i) =>
            {
        ...
        /// NDArray.
        /// </returns>
        public NDArray Sum(NDArray x, int dimension)
        {
        ...
        /// <param name="dimension">The dimension.</param>
        /// <returns></returns>
        public NDArray Minus(NDArray x, int dimension)
        {
            NDArray result = new NDArray(x.Shape[0]);
            result.Fill(0);
        ...
        /// <param name="dimension">The dimension.</param>
        /// <returns></returns>
        public NDArray Prod(NDArray x, int dimension)
        {
            NDArray result = new NDArray(x.Shape[0]);
            result.Fill(1);
        ...
        /// <param name="dimension">The dimension.</param>
        /// <returns></returns>
        public NDArray Min(NDArray x, int dimension)
        {
            NDArray result = new NDArray(x.Shape[0]);
            result.Fill(0);
        ...
        /// <param name="dimension">The dimension.</param>
        /// <returns></returns>
        public NDArray Max(NDArray x, int dimension)
        {
            NDArray result = new NDArray(x.Shape[0]);
            result.Fill(0);
        ...
        /// <param name="dimension">The dimension.</param>
        /// <returns>NDArray.</returns>
        public NDArray Argmin(NDArray x, int dimension)
        {
            NDArray result = new NDArray(x.Shape[0]);
            result.Fill(0);
        ...
        /// <param name="dimension">The dimension.</param>
        /// <returns>NDArray.</returns>
        public NDArray Argmax(NDArray x, int dimension)
        {
            NDArray result = new NDArray(x.Shape[0]);
            result.Fill(0);
        ...
        /// <param name="dimension">The dimension.</param>
        /// <returns></returns>
        public NDArray Mean(NDArray x, int dimension)
        {
            NDArray result = new NDArray(x.Shape[0]);
            result.Fill(0);
        ...
        /// <returns></returns>
        public NDArray Maximum(NDArray a, NDArray b)
        {
            var t1 = (a >= b);
            var t2 = (a > b);
        ...
        /// <param name="b">The b.</param>
        /// <returns></returns>
        public NDArray Maximum(NDArray a, float b)
        {
        ...
        /// <param name="b">The b.</param>
        /// <returns></returns>
        public NDArray Maximum(float a, NDArray b)
        {
        ...
        /// <param name="value">The value.</param>
        /// <returns>NDArray.</returns>
        public NDArray Norm(NDArray x, int dimension, float value) { dimension = dimension < 0 ? src.DimensionCount + dimension : dimension; return (NDArray)OpRegistry.Invoke("norm", null, src, dimension, value); }
        ...
        /// <returns>NDArray.</returns>
        public NDArray Std(NDArray x, int dimension, bool normByN) { dimension = dimension < 0 ? src.DimensionCount + dimension : dimension; return (NDArray)OpRegistry.Invoke("std", null, src, dimension, normByN); }
        /// <summary>
        ...
        /// <param name="normByN">if set to <c>true</c> [norm by n].</param>
        /// <returns>NDArray.</returns>
        public NDArray Var(NDArray x, int dimension, bool normByN) { dimension = dimension < 0 ? src.DimensionCount + dimension : dimension; return (NDArray)OpRegistry.Invoke("var", null, src, dimension, normByN); }
        ...
        /// <param name="value">The value.</param>
        /// <returns>NDArray.</returns>
        public NDArray Norm(NDArray x, float value) { return (NDArray)OpRegistry.Invoke("normall", null, src, value); }
        /// <summary>
        /// Standards all.
        /// </summary>
        /// <param name="result">The result.</param>
        /// <param name="src">The source.</param>
        /// <returns>NDArray.</returns>
        public NDArray Std(NDArray x) { return (NDArray)OpRegistry.Invoke("stdall", null, src); }
        /// <summary>
        /// Variables all.
        /// </summary>
        /// <param name="result">The result.</param>
        /// <param name="src">The source.</param>
        /// <returns>NDArray.</returns>
        public NDArray Var(NDArray x) { return (NDArray)OpRegistry.Invoke("varall", null, src); }
        */
    }
}
