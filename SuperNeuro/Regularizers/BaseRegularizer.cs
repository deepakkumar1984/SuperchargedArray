namespace SuperNeuro.Regularizers
{
    ...
    public abstract class BaseRegularizer
    {
        ...
        /// </summary>
        /// <param name="x">The SuperArray data x.</param>
        /// <returns></returns>
        internal abstract float Call(SuperArray x);
        ...
        /// <param name="x">The SuperArray data x.</param>
        /// <returns></returns>
        internal abstract SuperArray CalcGrad(SuperArray x);
    }
}
