namespace SuperNeuro.Layers
{
    ...
    public class BatchNormalization : BaseLayer
    {
        ...
        /// <summary>
        /// If True, add offset of beta to normalized SuperArray. If False, beta is ignored.
        /// </summary>
        /// <value>
        ...
        /// <param name="center">If True, add offset of beta to normalized SuperArray. If False, beta is ignored.</param>
