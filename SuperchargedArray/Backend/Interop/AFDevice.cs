...
namespace SuperchargedArray.Backend.Interop
{
    ...
    internal static class AFDevice
	{
		...
		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_device_array(out IntPtr array_arr, [In] bool[] data, uint ndims, [In] long[] dim_dims, DataType type);
		...
		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_device_array(out IntPtr array_arr, [In] float[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_device_array(out IntPtr array_arr, [In] double[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_device_array(out IntPtr array_arr, [In] int[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_device_array(out IntPtr array_arr, [In] long[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_device_array(out IntPtr array_arr, [In] uint[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_device_array(out IntPtr array_arr, [In] ulong[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_device_array(out IntPtr array_arr, [In] byte[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_device_array(out IntPtr array_arr, [In] short[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_device_array(out IntPtr array_arr, [In] ushort[] data, uint ndims, [In] long[] dim_dims, DataType type);
