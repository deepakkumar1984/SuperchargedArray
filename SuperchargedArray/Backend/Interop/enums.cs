...
namespace SuperchargedArray.Backend.Interop
{
	...
	public enum DataType
	{
		...
		Complex32,    ///< 32-bit complex floating point values
		Float64,    ///< 64-bit complex floating point values
		Complex64,    ///< 64-bit complex floating point values
		Boolean ,    ///< 8-bit boolean values
		Int32,    ///< 32-bit signed integral values
		UInt32,    ///< 32-bit unsigned integral values
		Byte ,    ///< 8-bit unsigned integral values
		Int64,    ///< 64-bit signed integral values
		UInt64,    ///< 64-bit unsigned integral values
		// #if AF_API_VERSION >= 32
		Int16,    ///< 16-bit signed integral values
		// #endif
		// #if AF_API_VERSION >= 32
		UInt16,    ///< 16-bit unsigned integral values
		// #endif
	}
	...
	{
		DEFAULT = 0,  ///< Default backend order: OpenCL -> CUDA -> CPU
		CPU     = 1,  ///< CPU a.Ops.a sequential algorithms
		CUDA    = 2,  ///< CUDA Compute Backend
		OPENCL  = 4,  ///< OpenCL Compute Backend
	}
