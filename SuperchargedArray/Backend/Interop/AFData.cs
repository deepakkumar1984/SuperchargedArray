...
namespace SuperchargedArray.Backend.Interop
{
    ...
    internal static class AFData
	{
		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_constant(out IntPtr array_arr, double val, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_constant_complex(out IntPtr array_arr, double real, double imag, uint ndims, [In] long[] dim_dims, DataType type);
		...
		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_range(out IntPtr array_out, uint ndims, [In] long[] dim_dims, int seq_dim, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_iota(out IntPtr array_out, uint ndims, [In] long[] dim_dims, uint t_ndims, [In] long[] dim_tdims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_randu(out IntPtr array_out, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_randn(out IntPtr array_out, uint ndims, [In] long[] dim_dims, DataType type);
		...
		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_identity(out IntPtr array_out, uint ndims, [In] long[] dim_dims, DataType type);
