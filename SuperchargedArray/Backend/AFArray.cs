...
namespace SuperchargedArray.Backend
{
    ...
    public partial class AFArray
	{
        [DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_create_array(out IntPtr array_arr, [In] bool[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_create_array(out IntPtr array_arr, [In] Complex[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_create_array(out IntPtr array_arr, [In] float[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_create_array(out IntPtr array_arr, [In] double[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_create_array(out IntPtr array_arr, [In] int[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_create_array(out IntPtr array_arr, [In] long[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_create_array(out IntPtr array_arr, [In] uint[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_create_array(out IntPtr array_arr, [In] ulong[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_create_array(out IntPtr array_arr, [In] byte[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_create_array(out IntPtr array_arr, [In] short[] data, uint ndims, [In] long[] dim_dims, DataType type);

		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_create_array(out IntPtr array_arr, [In] ushort[] data, uint ndims, [In] long[] dim_dims, DataType type);
		...
		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_create_handle(out IntPtr array_arr, uint ndims, [In] long[] dim_dims, DataType type);
		...
		[DllImport(af_config.dll, ExactSpelling = true, SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern af_err af_get_type(out DataType type, IntPtr array_arr);
